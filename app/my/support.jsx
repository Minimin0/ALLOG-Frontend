...
const faqs = [
  { q: '하트는 어떻게 다시 얻나요?', a: '출석, AAC SNS 팔로우, 웰니스 콘텐츠 확인, 친구 초대, 제휴 QR, 캠페인 참여 등 하트 이벤트 화면에서 다양한 방법으로 다시 얻을 수 있어요.' },
  { q: '루틴 인증은 어떻게 검토되나요?', a: 'AI가 관련성, 제출 시간, 중복 이미지, 이상 징후를 1차로 검토해요. 최종 진위 판정과 제재는 AI 단독이 아니라 신고와 운영 검토를 함께 거쳐요.' },
  { q: '완주하지 못하면 하트는 어떻게 되나요?', a: '개인 루틴 달성률 70% 이상이고 부정 인증 이력이 없어야 하트 1개가 반환돼요. 미완주 시 사용한 하트는 반환되지 않아요.' },
