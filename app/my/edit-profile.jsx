...
const s = StyleSheet.create({
  ...
  header: { height: 67, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', gap: 12 }, back: { width: 43, height: 43, borderRadius: 22, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' }, backText: { fontSize: 30, lineHeight: 32 }, headerTitle: { fontSize: 19, fontWeight: '700' },
  ...
  nickname: { height: 52, borderRadius: 26, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface, paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', gap: 12 }, sub: { fontSize: 12, color: colors.muted }, nicknameInput: { flex: 1, textAlign: 'center', textAlignVertical: 'center', paddingVertical: 0, fontSize: 15, fontWeight: '600' },
  // chip/active 둘 다 borderWidth 2로 고정하고 색만 바꾼다 — 굵기가 바뀌면 선택 시 카드 크기가
  // 미세하게 변해 옆 카드가 밀리기 때문(다른 온보딩 화면에서도 같은 이유로 고친 패턴).
  field: { gap: 8 }, fieldTitle: { color: colors.subtle, fontSize: 13, fontWeight: '700' }, center: { textAlign: 'center' }, chips: { flexDirection: 'row', gap: 8 }, chipGrid: { flexWrap: 'wrap', gap: 12 }, chip: { minHeight: 42, borderRadius: 15, borderWidth: 2, borderColor: colors.line, backgroundColor: colors.surface, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center' }, flexChip: { flex: 1 }, gridChip: { height: 54 }, twoColumn: { width: '48%' }, threeColumn: { width: '30.8%' }, active: { borderColor: colors.primary, backgroundColor: colors.primaryPale }, chipText: { fontSize: 12, fontWeight: '600' },
  birthField: { height: 48, borderRadius: 15, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center' }, birthInput: { flex: 1, height: '100%', textAlignVertical: 'center', paddingVertical: 0, fontSize: 14 }, calendar: { color: colors.primary, fontSize: 13, fontWeight: '700' }, coaches: { flexDirection: 'row', gap: 8 }, coach: { flex: 1, minHeight: 78, borderRadius: 15, borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' }, coachImage: { width: 44, height: 44 }, line: { height: 1, backgroundColor: colors.line }, sleep: { flexDirection: 'row', alignItems: 'baseline', justifyContent: 'center', gap: 8 }, sleepNumber: { fontSize: 28, fontWeight: '700' },
