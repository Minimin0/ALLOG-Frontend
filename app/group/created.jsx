...
export default function GroupCreatedScreen() {
  ...
  return (
    <SafeAreaView edges={['top', 'bottom']} className="flex-1 items-center justify-center gap-6 bg-bg px-8">
      ...
      <Pressable onPress={() => router.replace(groupId ? { pathname: '/group/waiting-room', params: { groupId } } : '/group/waiting-room')} className="w-full items-center justify-center rounded-[27.5px] bg-black py-4">
