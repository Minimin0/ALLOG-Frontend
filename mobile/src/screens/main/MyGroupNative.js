      ...
      <View style={s.tabs}>
        {["인증", "랭킹", "정보"].map((x) => (
          <Pressable key={x} style={s.tab} onPress={() => setTab(x)}>
            <Text style={[s.tabText, tab !== x && { color: colors.muted }]}>
              {x}
            </Text>
            <View
              style={[s.underline, tab === x && { backgroundColor: colors.ink }]}
            />
          </Pressable>
        ))}
      </View>
        ...
        return (
          <Animated.View
            ...
            style={[
              ...
              {
                opacity,
                backgroundColor: index % 2 ? "#f0cf68" : colors.heart,
                transform: [
...
const s = StyleSheet.create({
  ...
  wait: { backgroundColor: colors.surfaceAlt },
  ...
  pendingMe: { backgroundColor: colors.primaryTint },
  ...
  smallButtonText: { fontSize: 11, fontWeight: "700", color: colors.white },
  ...
  avatarDarkText: { fontSize: 10, fontWeight: "600", color: colors.white },
  verifiedCard: {
    width: "48%",
    aspectRatio: 3 / 4,
    borderRadius: 18,
  ...
  moreText: { fontSize: 22, color: colors.white },
  verifiedInfo: {
    position: "absolute",
    left: 9,
    bottom: 9,
  ...
  verifiedName: { fontSize: 11, fontWeight: "700", color: colors.white },
  ...
  rankNo: { width: 20, fontSize: 18, fontWeight: "700", color: colors.primary },
  rankGold: {
    borderWidth: 2,
    borderColor: "#d6aa47",
  ...
  memberAvatarText: { color: colors.white, fontSize: 12, fontWeight: "700" },
  ...
  successRate: { fontSize: 20, fontWeight: "800", color: colors.primary },
  successTrack: {
    marginVertical: 9,
    height: 8,
    borderRadius: 4,
  ...
  successGoal: { fontSize: 11, color: colors.reward },
  infoStats: {
    marginTop: 4,
    height: 84,
    flexDirection: "row",
  ...
  infoDivider: { width: 1, height: 48, backgroundColor: colors.line },
  podium: {
    height: 150,
    flexDirection: "row",
    alignItems: "flex-end",
  ...
  copyToastText: { color: colors.primary, fontSize: 13, fontWeight: "700" },
  outline: {
    height: 44,
    borderRadius: 16,
    borderWidth: 1,
