...
export function GroupIcon({ color = colors.ink, size = 24 }) {
  return (
...
export function SearchIcon({ color = colors.ink, size = 24 }) {
  return (
...
export function HomeIcon({ color = colors.ink, size = 24 }) {
  return (
    <Svg viewBox="0 0 24 24" width={size} height={size} fill={color}>
...
export function GiftIcon({ color = colors.ink, size = 24 }) {
  return (
    <Svg viewBox="0 0 24 24" width={size} height={size} fill={color}>
...
export function PersonIcon({ color = colors.ink, size = 24 }) {
  return (
    <Svg viewBox="0 0 24 24" width={size} height={size} fill={color}>
